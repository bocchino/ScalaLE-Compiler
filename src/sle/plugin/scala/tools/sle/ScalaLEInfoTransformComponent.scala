 ...
 */
class ScalaLEInfoTransformComponent(val global: Global) extends PluginComponent
  ...
  def newTransformer(unit: CompilationUnit) = new ScalaLETransformer
   ...
   *  @todo Implement.
   */
  class ScalaLETransformer extends /*Typing*/ Transformer {
